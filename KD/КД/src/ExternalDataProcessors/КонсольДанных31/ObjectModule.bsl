...
#Область ДАННЫЕ_ФОРМЫ_ИЗ_ПАРАМЕТРОВ

// Возвращает в форму данные СПарам
// Параметры:
//	Параметры_ - ТаблицаЗначений - Приёмник данных, колонки ИмяПараметра и ЗначениеПараметра
//	Прм - Структура - Обычно возвращаемые из выполняемого блока параметры (СПарам)
Процедура СтруктуруПараметровВФорму(Параметры_, Прм) Экспорт
...
//		*ИменаНастроек - СписокЗначений из Строка - Список имён сохранённых настроек 
...
//Записывает команду в хранилище
// Параметры:
